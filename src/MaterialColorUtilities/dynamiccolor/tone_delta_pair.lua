...
export type TonePolarity = "darker"
| "lighter"
| "nearer"
| "farther"
| "relative_darker"
...
export type DeltaConstraint = "exact"
| "nearer"
| "farther";
--[[*
...
type ToneDeltaPair_statics = { new: (roleA:DynamicColor, roleB:DynamicColor, delta:number, polarity:TonePolarity, stayTogether:boolean, constraint:DeltaConstraint?) -> ToneDeltaPair, }
local ToneDeltaPair = {} :: ToneDeltaPair & ToneDeltaPair_statics;
(ToneDeltaPair :: any).__index = ToneDeltaPair;
--[[*
...
function ToneDeltaPair.new(roleA: DynamicColor,roleB: DynamicColor,delta: number,polarity: TonePolarity,stayTogether: boolean,constraint: DeltaConstraint?): ToneDeltaPair
...
self.constraint = if constraint ~= nil
then constraint
else "exact";
return (self :: any) :: ToneDeltaPair;
end
