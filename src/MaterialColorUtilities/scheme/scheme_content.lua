...
export type SchemeContent = DynamicScheme & {}
type SchemeContent_statics = {
	new: (
		sourceColorHct: Hct,
		isDark: boolean,
...
) :: SchemeContent & SchemeContent_statics;
(SchemeContent :: any).__index = SchemeContent
function SchemeContent.new(
	sourceColorHct: Hct,
	isDark: boolean,
	contrastLevel: number,
	specVersion_: SpecVersion?,
	...
	local self = setmetatable({}, SchemeContent) --[[ ROBLOX TODO: super constructor may be used ]]
