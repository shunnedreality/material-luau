...
export type SchemeMonochrome = DynamicScheme & {}
type SchemeMonochrome_statics = {
	new: (
		sourceColorHct: Hct,
		isDark: boolean,
...
) :: SchemeMonochrome & SchemeMonochrome_statics;
(SchemeMonochrome :: any).__index = SchemeMonochrome
function SchemeMonochrome.new(
	sourceColorHct: Hct,
	isDark: boolean,
	contrastLevel: number,
	specVersion_: SpecVersion?,
	...
	local self = setmetatable({}, SchemeMonochrome) --[[ ROBLOX TODO: super constructor may be used ]]
	...
	return (self :: any) :: SchemeMonochrome
end
