...
export type SchemeFidelity = DynamicScheme & {}
type SchemeFidelity_statics = {
	new: (
		sourceColorHct: Hct,
		isDark: boolean,
...
local SchemeFidelity = (
	setmetatable({}, { __index = DynamicScheme }) :: any
) :: SchemeFidelity & SchemeFidelity_statics;
(SchemeFidelity :: any).__index = SchemeFidelity
function SchemeFidelity.new(
	sourceColorHct: Hct,
	isDark: boolean,
	contrastLevel: number,
	specVersion_: SpecVersion?,
	...
	local self = setmetatable({}, SchemeFidelity) --[[ ROBLOX TODO: super constructor may be used ]]
	...
	return (self :: any) :: SchemeFidelity
end
