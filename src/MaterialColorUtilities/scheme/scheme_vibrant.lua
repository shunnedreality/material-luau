...
export type SchemeVibrant = DynamicScheme & {}
type SchemeVibrant_statics = {
	new: (
		sourceColorHct: Hct,
		isDark: boolean,
...
) :: SchemeVibrant & SchemeVibrant_statics;
(SchemeVibrant :: any).__index = SchemeVibrant
function SchemeVibrant.new(
	sourceColorHct: Hct,
	isDark: boolean,
	contrastLevel: number,
	specVersion_: SpecVersion?,
	...
	local self = setmetatable({}, SchemeVibrant) --[[ ROBLOX TODO: super constructor may be used ]]
