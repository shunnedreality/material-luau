...
export type SchemeExpressive = DynamicScheme & {}
type SchemeExpressive_statics = {
	new: (
		sourceColorHct: Hct,
		isDark: boolean,
...
) :: SchemeExpressive & SchemeExpressive_statics;
(SchemeExpressive :: any).__index = SchemeExpressive
function SchemeExpressive.new(
	sourceColorHct: Hct,
	isDark: boolean,
	contrastLevel: number,
	specVersion_: SpecVersion?,
	...
	local self = setmetatable({}, SchemeExpressive) --[[ ROBLOX TODO: super constructor may be used ]]
	...
	return (self :: any) :: SchemeExpressive
end
